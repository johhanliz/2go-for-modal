...
UUID = os.environ.get('UUID', '59fc457e-35f4-401b-ba77-734d8a2c1f0b')       # UUID
...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'modal.liveinatree.eu.org')                             # 国定隧道域名，留空即启用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiNzkwYjRlNGJmNzQxNzhjZTZjM2E4ZTIxMTZhZjVmZjEiLCJ0IjoiOTJhYjE0NWUtYTIzNS00ZmJkLTk4OWUtMDczYWU4Y2ZjMGE5IiwicyI6Ik56TXpObUV5WlRJdFpHRm1ZeTAwTmprekxUZzVPREF0WVRGaU5USXdaVFZpTURobSJ9')                                 # 国定隧道json或token，留空即启用临时隧道,json获取地址：https://fscarmen.cloudflare.now.cc
